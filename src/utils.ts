...
export const SquareIndex : Record<Square, number> = {
    "a1" : 0 + 8 * 0, "b1" : 1 + 8 * 0, "c1" : 2 + 8 * 0, "d1" : 3 + 8 * 0, "e1" : 4 + 8 * 0, "f1" : 5 + 8 * 0, "g1" : 6 + 8 * 0, "h1" : 7 + 8 * 0, 
    "a2" : 0 + 8 * 1, "b2" : 1 + 8 * 1, "c2" : 2 + 8 * 1, "d2" : 3 + 8 * 1, "e2" : 4 + 8 * 1, "f2" : 5 + 8 * 1, "g2" : 6 + 8 * 1, "h2" : 7 + 8 * 1, 
    "a3" : 0 + 8 * 2, "b3" : 1 + 8 * 2, "c3" : 2 + 8 * 2, "d3" : 3 + 8 * 2, "e3" : 4 + 8 * 2, "f3" : 5 + 8 * 2, "g3" : 6 + 8 * 2, "h3" : 7 + 8 * 2, 
    "a4" : 0 + 8 * 3, "b4" : 1 + 8 * 3, "c4" : 2 + 8 * 3, "d4" : 3 + 8 * 3, "e4" : 4 + 8 * 3, "f4" : 5 + 8 * 3, "g4" : 6 + 8 * 3, "h4" : 7 + 8 * 3, 
    "a5" : 0 + 8 * 4, "b5" : 1 + 8 * 4, "c5" : 2 + 8 * 4, "d5" : 3 + 8 * 4, "e5" : 4 + 8 * 4, "f5" : 5 + 8 * 4, "g5" : 6 + 8 * 4, "h5" : 7 + 8 * 4, 
    "a6" : 0 + 8 * 5, "b6" : 1 + 8 * 5, "c6" : 2 + 8 * 5, "d6" : 3 + 8 * 5, "e6" : 4 + 8 * 5, "f6" : 5 + 8 * 5, "g6" : 6 + 8 * 5, "h6" : 7 + 8 * 5, 
    "a7" : 0 + 8 * 6, "b7" : 1 + 8 * 6, "c7" : 2 + 8 * 6, "d7" : 3 + 8 * 6, "e7" : 4 + 8 * 6, "f7" : 5 + 8 * 6, "g7" : 6 + 8 * 6, "h7" : 7 + 8 * 6, 
    "a8" : 0 + 8 * 7, "b8" : 1 + 8 * 7, "c8" : 2 + 8 * 7, "d8" : 3 + 8 * 7, "e8" : 4 + 8 * 7, "f8" : 5 + 8 * 7, "g8" : 6 + 8 * 7, "h8" : 7 + 8 * 7, 
}
